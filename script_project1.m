...
% Initialize Galaxy 1
[m_core1, rcore_initial1, vcore_initial1, n_stars1, rstar_initial1, vstar_initial1] = initializegalaxy();
N_cores = 1;

% Initialize Galaxy 2 (if testing one galaxy at rest, comment this out)
[m_core2, rcore_initial2, vcore_initial2, n_stars2, rstar_initial2, vstar_initial2] = initializegalaxy();
N_cores = N_cores + 1;
...
% If testing resting galaxy, the following vectors should all be zero
...
%plot(x_core1,y_core1,'r'); %plot x vs y of core1
%plot(x_core2,y_core2,'b'); %plot x vs y of core1
...
% Initialize range for plotting
    range_x = [x_core1(:); x_core2(:); x_star1(:); x_star2(:)];
    range_y = [y_core1(:); y_core2(:); y_star1(:); y_star2(:)];
